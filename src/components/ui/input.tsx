...
function Input({ className, type, ...props }: React.ComponentProps<'input'>) {
  return (
    <input
      ...
      data-slot='input'
      className={cn(
        'ring-secondary/80 file:text-foreground placeholder:text-muted-foreground selection:bg-primary selection:text-primary-foreground ring-offset-background flex h-9 w-full min-w-0 rounded-md border-none bg-transparent px-3 py-1 text-base ring-2 ring-offset-2 transition-[color,box-shadow] outline-none file:inline-flex file:h-7 file:bg-transparent file:text-sm file:font-medium file:ring-0 disabled:pointer-events-none disabled:cursor-not-allowed disabled:opacity-50 md:text-sm',
